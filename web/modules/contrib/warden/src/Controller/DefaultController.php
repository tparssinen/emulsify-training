...
class DefaultController extends ControllerBase {
  ...
  public function wardenRegistration() {
    ...
    if (empty($warden_path)) {
      \Drupal::messenger()->addMessage(t('You are missing some Warden configuration. Please read the README file for more details.'), MessengerInterface::TYPE_ERROR);
      return [];
    }
  ...
  public function wardenAccess() {
    ...
    if (!$this->getWardenManager()->isValidWardenToken($_POST['token'], \Drupal::time()->getRequestTime())) {
