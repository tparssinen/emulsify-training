...
class WardenManagerTest extends UnitTestCase {
  ...
  protected function setUp() {
    ...
    $this->infoParser = $this->createMock('Drupal\Core\Extension\InfoParser', array(), array(), '', FALSE);
    $this->configFactory = $this->createMock('Drupal\Core\Config\ConfigFactory', array(), array(), '', FALSE);
  ...
  protected function expectConfigFactoryAccess() {
    $wardenConfig = $this->createMock('Drupal\Core\Config\Config', array(), array(), '', FALSE);
    $systemConfig = $this->createMock('Drupal\Core\Config\Config', array(), array(), '', FALSE);
